...
public class Activity_Registered_complaints_description extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reg_complaints_description);
        ...
        txt_phone_no.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (str_call_number.equals("")) {
                    TastyToast.makeText(Activity_Registered_complaints_description.this, "Number Not Available :(", TastyToast.LENGTH_LONG, TastyToast.ERROR);
                } else {
    ...
    private void FunctionCAllAlert(final String str_number) {
        ...
        new android.app.AlertDialog.Builder(Activity_Registered_complaints_description.this)
                .setTitle("Gem India")
                ...
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog,
                        ...
                        try {
                            ...
                            if (ActivityCompat.checkSelfPermission(Activity_Registered_complaints_description.this,
