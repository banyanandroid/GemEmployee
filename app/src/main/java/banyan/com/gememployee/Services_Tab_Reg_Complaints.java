 ...
 */
public class Services_Tab_Reg_Complaints extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                Intent i = new Intent(getApplicationContext(), Activity_Registered_complaints_description.class);
                startActivity(i);
            }
    ...
    public void Function_GetReg_jobs() {
        ...
        String str_url = "http://gemservice.in/employee_app/reg_comp_user.php";
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (success == 1) {
                        ...
                        arr = obj.getJSONArray("complaints");
                        ...
                        for (int i = 0; arr.length() > i; i++) {
                            ...
                            adapter = new Completed_complaints_Adapter(Services_Tab_Reg_Complaints.this,
                                    complaint_list);
