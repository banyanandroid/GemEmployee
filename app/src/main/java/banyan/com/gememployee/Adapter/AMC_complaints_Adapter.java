...
import banyan.com.gememployee.Services_Tab_Reg_AMC_Complaints;


public class AMC_complaints_Adapter extends BaseAdapter {
    ...
    public AMC_complaints_Adapter(Activity a, ArrayList<HashMap<String, String>> d) {
        activity = a;
        data = d;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        comp_no.setText(result.get(Services_Tab_Reg_AMC_Complaints.TAG_AMC_NO));
        cus_name.setText(result.get(Services_Tab_CompletedComplaints.TAG_CUSTOMER));
        comp_status.setText(result.get(Services_Tab_Reg_AMC_Complaints.TAG_STATUS));

        String str_product = result.get(Services_Tab_Reg_AMC_Complaints.TAG_PRODUCT_NAME);
